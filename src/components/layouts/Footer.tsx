        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="flex flex-col gap-6">
            ...
            <p className="text-sm text-muted-foreground max-w-xs leading-relaxed">
              Empowering your future with sustainable solar energy solutions.
              From residential installations to commercial projects, we provide
          ...
          <div>
            <h4 className="text-sm font-semibold mb-6 uppercase tracking-wider text-foreground">
              Quick Links
            </h4>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-sm text-muted-foreground">
                  Shop No.7, Society Shopping Complex Near Shiv Mandir, Phase-I, Vasant Vihar Dhradun(Uttarakhand)
                </span>
              </li>
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Registration through PM SURYA GHAR App for complete benefits of
              government yojna.
            </p>
            <div className="bg-background/50 p-4 rounded-lg border border-border/50">
              ...
              <p className="text-xs text-muted-foreground">
                10% booking amount required to initiate registration and site
                assessment.
              </p>
            </div>
          </div>
